...
public abstract class GetRankingTask extends AccessServerTask {
    ...
    protected abstract String getReceiverOnServer();

    @Override
    protected ServerRequest createServerRequest() {
        return new ServerRequest(getReceiverOnServer());
    }
