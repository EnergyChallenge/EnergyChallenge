	...
	\paragraph{AppController}Die Klasse, die f\"ur die Kommunikation zwischen Server und App verantwortlich ist und Anfragen der App verarbeitet.
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item getTeamProfile(): Methode, die die aktuelle Team-Rangliste aus der Datenbank liest und als JSON Objekt an die App sendet. %TODO
				\item getUserProfile(): Methode, die die aktuelle Team-Rangliste aus der Datenbank liest und als JSON Objekt an die App sendet. %TODO
				\item getActivities(): Methode, die die aktuelle Team-Rangliste aus der Datenbank liest und als JSON Objekt an die App sendet. %TODO
				\item getFavoriteActivities(): Methode, die die aktuelle Team-Rangliste aus der Datenbank liest und als JSON Objekt an die App sendet. %TODO
				\item getProposals(): Methode, die die aktuelle Team-Rangliste aus der Datenbank liest und als JSON Objekt an die App sendet. %TODO
				\item getProposal(): Methode, die die aktuelle Team-Rangliste aus der Datenbank liest und als JSON Objekt an die App sendet. %TODO
				\item search(): Methode, die die aktuelle Team-Rangliste aus der Datenbank liest und als JSON Objekt an die App sendet. %TODO
				\item doActivity(): Methode, die die aktuelle Team-Rangliste aus der Datenbank liest und als JSON Objekt an die App sendet. %TODO
				\item commentProposal(): Methode, die die aktuelle Team-Rangliste aus der Datenbank liest und als JSON Objekt an die App sendet. %TODO
			\end{itemize}
		\end{itemize}
