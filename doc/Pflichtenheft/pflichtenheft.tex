...
\subsection{Aktivit\"aten}
	...
	\centering
		...
		\caption{Use Case 1.3 (Aktivitäten)}
	\end{figure}
...
\begin{figure}[H]
	...
	\caption{Erste Seite zur Verwalten der eigenen Aktivitäten: hier können Aktivitäten zu Favoriten hinzugefügt werden oder als erledigt markiert werden.}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{gfx/mockups/website-erledigte-aktivitaeten.pdf}
	\caption{Zweite Seite zur Verwalten der eigenen Aktivitäten: hier könnenInformationen zu erledigten Aktivitäten eingesehen werden.}
\end{figure}
\begin{figure}[H]
	\centering
...
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm]{gfx/mockups/app-login.pdf}
	\caption{Bildschirm zum Anmelden}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm]{gfx/mockups/app-main.pdf}
	\caption{Startbildschirm der App}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm]{gfx/mockups/app-navigation.pdf}
	\caption{Navigationsbildschirm der App}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm]{gfx/mockups/app-meinprofil.pdf}
	\caption{Übersicht über das eigene Profil in der App}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm]{gfx/mockups/app-rangliste.pdf}
	\caption{Ranglistenansicht in der App}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm]{gfx/mockups/app-aktivitaeten.pdf}
	\caption{Aktivitätenansicht in der App}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm]{gfx/mockups/app-vorschlaege.pdf}
